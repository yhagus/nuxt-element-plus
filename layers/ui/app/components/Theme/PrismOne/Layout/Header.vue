...
<template>
  <div class="header">
    <div class="header__left">
      ...
      <div>
        <span class="header__eyebrow">Prism Lab</span>
    ...
    <div ref="menuRef" class="header__right">
      ...
      <div class="header__profile">
        <button type="button" class="header__profile-button" @click.stop="toggleMenu">
          ...
          <span class="header__profile-avatar">P</span>
        </button>
...
.header {
  ...
  gap: 16px;
  padding: 14px 16px;
  border: 1px solid rgba(173, 133, 255, 0.2);
  border-radius: 22px;
  background: rgba(255, 255, 255, 0.82);
  box-shadow: 0 18px 40px rgba(170, 115, 255, 0.1);
...
.header__chip {
  ...
  padding: 10px 14px;
  border-radius: 999px;
  background: linear-gradient(90deg, #ff79b0, #7ddcff);
  color: #fff;
  font-size: 13px;
  font-weight: 700;
}
...
.header__profile-avatar {
  ...
  height: 32px;
  border-radius: 999px;
  background: linear-gradient(135deg, #ff79b0, #7ddcff);
  color: #fff;
  font-size: 12px;
  font-weight: 700;
}
.header__menu {
  ...
  border-radius: 16px;
  background: #fff;
  box-shadow: 0 18px 40px rgba(170, 115, 255, 0.16);
}
.header__menu-item {
  display: block;
  width: 100%;
