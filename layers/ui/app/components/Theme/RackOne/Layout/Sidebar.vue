...
const items = [
  ...
  { title: 'Archive', path: '/archive', icon: 'lucide:archive' },
  { title: 'Assets', path: '/assets', icon: 'lucide:image' },
...
<template>
  <div class="sidebar">
    <div class="sidebar__brand">
      <span class="sidebar__mark">R1</span>
      <div class="sidebar__copy">
        <strong>Rack One</strong>
        <span>Inset compact</span>
      </div>
    </div>
